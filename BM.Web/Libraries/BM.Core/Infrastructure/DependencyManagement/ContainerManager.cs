...
namespace BM.Core.Infrastructure.DependencyManagement
{
    /// <summary>
    /// Container Manager
    /// </summary>
    public class ContainerManager
    {
        ...
        /// </summary>
        /// <typeparam name="T">Type</typeparam>
        /// <param name="scope">Scope;pass null to aautomatically resolve the current scope</param>
        /// <returns>Resolved service</returns>
        ...
        public virtual ILifetimeScope Scope()
        {
            ...
            catch (Exception)
            {
                ...
                //when such lifetime scope is returned, you should be sure that is'll be disposed once used(e.g. in schedule tasks)
                return Container.BeginLifetimeScope(MatchingScopeLifetimeTags.RequestLifetimeScopeTag);
            }
        }
    }

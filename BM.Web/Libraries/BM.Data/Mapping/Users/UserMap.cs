...
namespace BM.Data.Mapping.Users
{
    public partial class UserMap : EntityTypeConfiguration<User>
    {
        public UserMap()
        {
            ...
            this.Property(p => p.DefaultName).HasColumnType("char").HasMaxLength(6).IsFixedLength().IsRequired();
            ...
            this.Property(p => p.Salt).HasColumnType("char").IsFixedLength().HasMaxLength(8);
            this.Property(p => p.SaltPassword).HasColumnType("char").HasMaxLength(50); //确认SHA1加密后的长度在定长
